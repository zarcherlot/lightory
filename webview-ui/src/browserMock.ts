/**
 * Browser runtime mock that fetches assets and injects the same events the
 * browser server would send.
 *
 ...
 *
 * Only imported in Vite dev mode for UI prototyping without a server.
 */
