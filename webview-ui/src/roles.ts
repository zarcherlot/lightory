...
export const roleDefinitions: RoleDefinition[] = [
  ...
  },
  {
    ...
    title: '新闻收集员',
    palette: 1,
    taskFile: 'roles/news-collector.md',
    abilityCards: ['热点新闻卡'],
    resultCard: '热点新闻卡',
    responsibility: '收集适合学生了解的近期热点，整理成少量候选素材。',
    roleTaskIcon: 'card',
  },
  {
    id: 'newsFilter',
    ...
    title: '新闻过滤员',
    palette: 2,
    taskFile: 'roles/news-filter.md',
    abilityCards: ['适合摘抄卡'],
    resultCard: '适合摘抄卡',
    responsibility: '过滤不适合小学生摘抄的新闻，并说明保留或过滤原因。',
    roleTaskIcon: 'card',
  },
  {
    id: 'copyworkPicker',
    ...
    title: '摘抄推荐员',
    palette: 3,
    taskFile: 'roles/copywork-picker.md',
    abilityCards: ['候选新闻卡'],
    resultCard: '候选新闻卡',
    responsibility: '把适合摘抄的新闻整理成 A/B/C 选项，方便学生交互选择。',
    roleTaskIcon: 'card',
  },
];
